...
def check_diversification(user_data: Dict) -> Optional[str]:
    """
    Проверить, нужно ли пользователю диверсифицировать валюты
...
if __name__ == "__main__":
    ...
    # Тест форматирования курсов
    rates_text = format_exchange_rates(test_rates)
    print(f"✅ Форматирование курсов работает")
    
    # Тест проверки диверсификации
    tip = check_diversification(test_user)
    print(f"✅ Проверка диверсификации: {tip[:50]}..." if tip else "✅ Проверка диверсификации: нет проблем")
